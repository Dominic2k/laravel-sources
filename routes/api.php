...
Route::prefix('public')->group(function () {
    ...
    // Chuyển logic xử lý vào StudentClassController
    Route::get('student/{user_id}/classes', [StudentClassController::class, 'getClasses']);
    Route::get('student/{user_id}/class-details', [StudentClassController::class, 'getClassDetails']);
});
